...
def computeSilhouetteKm(X, k):
    ...
    return silhouette_scores_kmeans


def plotSilhouttee(silhouette_scores_kmeans):
    """
    The function plot number of clusters vs
    silhouttee coefficient synthetic values and kmeans values.
    """
    plt.figure(figsize=(10, 6))
    plt.plot(range(1, 10), silhouette_scores_kmeans, marker='*', linestyle='-', color="m")
...
plotSilhouttee(computeSilhouetteKm(loadDataset(), 9))
